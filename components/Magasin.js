...
import {Text, TouchableOpacity, View, Image, Modal, ScrollView, Button, ImageBackground} from 'react-native';
    ...
    return (
        <Modal
          ...
          <View style={{position: 'absolute', top: 160, right: 0, left: 0, flex: 1, alignItems: 'center', justifyContent: 'center', alignContent: 'center'}}>
            ...
            <Button onPress={this.props.closeMagasinModal} title="Retour" color="red"/>
          </View>
          </ImageBackground>
        </Modal>
    );
